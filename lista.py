tasks = []
tasks.append({'id': 1, 'name': 'AUTOMACAO CRIAR TXT', 'time': '19:05', 'path': r'C:\Temp\ORCHESTRATOR PYTHON\envio', 'status': 'Pendente'})
tasks.append({'id': 2, 'name': 'CRIAR ARQUIVO', 'time': '10:10', 'path': r'C:\temp\123', 'status': 'Pendente'})
